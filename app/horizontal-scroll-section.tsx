        ...
        className={
          mode === "pin"
            ...
            : mode === "swipe"
              ...
              : "flex flex-col px-[3vw] py-[clamp(72px,10vw,140px)] max-[680px]:px-[18px]"
        }
      >
        <header className="relative z-[2] flex shrink-0 items-center justify-between gap-6 px-[3vw] pt-[max(7.5rem,calc(env(safe-area-inset-top)+5.75rem))] pb-5 max-[680px]:px-[18px] max-[680px]:pt-[max(6.5rem,calc(env(safe-area-inset-top)+5rem))]">
          <p className="m-0 text-[11px] tracking-[0.1em] text-acid uppercase">{kicker}</p>
          <p
        ...
        {mode === "swipe" ? (
          <>
            {heading ? (
              <h2
                id={headingId}
                className="font-display mx-[3vw] mt-4 mb-6 max-w-[18ch] text-[clamp(26px,7vw,40px)] leading-[0.94] font-[560] tracking-[-0.06em] max-[680px]:mx-[18px]"
              >
                {heading}
              </h2>
            ) : null}
            <div className="grid shrink-0 place-items-center px-[3vw] pt-1 pb-8 max-[680px]:px-[18px]">
              {graph}
            </div>
            <div
        ...
        {mode === "pin" ? (
          ...
          <div className="relative z-[2] mx-[3vw] mb-4 h-[3px] shrink-0 bg-paper/15" aria-hidden="true">
            <span
...
function Panel({
  ...
  return (
    <article
      ...
      className={
        pin
          ...
          : swipe
            ? "flex min-h-[42svh] w-full min-w-full shrink-0 snap-start snap-always flex-col gap-4 border-r border-paper/12 px-[3vw] py-8 max-[680px]:px-[18px]"
    ...
    >
      ...
      <h3
        id={headingId}
        className="font-display m-0 max-w-[14ch] text-[clamp(30px,4.2vw,68px)] leading-[0.88] font-[620] tracking-[-0.07em]"
      >
        {panel.title}
      </h3>
      {panel.icons?.length ? (
